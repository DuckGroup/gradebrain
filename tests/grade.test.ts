...
describe("POST /grade", () => {
  it("returns a grade result", async () => {
    ...
    mockedClient.gradeCompletion.mockResolvedValue(
      '{"correct":true,"points":17,"comment":"The submission covers the required topics and matches the syllabus well. It was missing a deeper explanation of security tradeoffs and some implementation details."}',
    );
